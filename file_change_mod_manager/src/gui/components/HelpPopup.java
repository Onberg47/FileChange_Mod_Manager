...
public class HelpPopup {
    ...
    private void loadHelpContent() {
        try {
            ...
            String html = ResourceLoader.getResourceAsString("resources/help/" + viewId + ".html");
    ...
    public static void openHelpInBrowser() {
        try {
            URI helpUrl = ResourceLoader.getResourceUrl("resources/help/web-manual.html").toURI();
